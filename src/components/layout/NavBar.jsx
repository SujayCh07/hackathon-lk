    ...
    <header className="sticky top-0 z-50 border-b border-navy/10 bg-white/95 text-navy shadow-sm backdrop-blur">
      ...
      <nav className="mx-auto flex max-w-6xl items-center justify-between px-6 py-2" aria-label="Primary">
        ...
        <div className="hidden items-center gap-3 md:flex">
          {user ? (
            ...
            >
              ...
              {isAccountMenuOpen && (
                <div className="absolute right-0 mt-2 w-56 rounded-3xl border border-navy/10 bg-white/95 p-4 shadow-xl shadow-navy/10">
        ...
        <details className="relative md:hidden" role="list">
          ...
          <div className="absolute right-0 mt-2 w-48 rounded-3xl border border-navy/10 bg-white/95 p-4 shadow-xl shadow-navy/10">
